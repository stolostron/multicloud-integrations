...
func (r *ReconcileGitOpsCluster) reconcileGitOpsCluster(
	...
	if gitopsAddonEnabled {
		...
		klog.Infof("Successfully ensured GitOps addon prerequisites (RBAC) for GitOpsCluster %s/%s in ArgoCD namespace %s", instance.Namespace, instance.Name, argoNamespace)
